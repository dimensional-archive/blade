...
export declare type Modifier<D, T> = (ctx?: Context, text?: Content, data?: D) => T | Promise<T>;
export declare type Supplier<D, T> = (message: Message, data?: D) => T | Promise<T>;
export declare type ArgumentTypeCaster = (message: Message, value?: any) => any;
