...
import { CommandStore, InhibitorStore, SubscriberStore, MonitorStore } from "../../structures";
import { Message, Constants } from "eris";
import { BladeClient } from "../../Client";
import { Collection, ArgumentTypes } from "../../util";
import { URL } from "url";
...
export class TypeResolver {
  ...
  public listeners: SubscriberStore | null;
